<template>
  <div class="app-container">
    ...
    <el-dialog class="watchDialog" title="回收订单管理" :visible.sync="dialogTableVisible">
      ...
      <div class="dialog-container" v-show="watchContent.state==='完成'">
        ...
        <div class="dialog-container dialog-eva">
          <el-input type="textarea" v-model="watchContent.evaContent"></el-input>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      async getData() {
        ...
        const { code, data, err } = await api.orderPagination({ currentPage: this.currentPage, pageSize: this.pageSize, address: this.form.city + this.form.area , ifOwn: this.form.ifOwn, merhantId: this.form.merhantId, orderCode: this.form.orderCode, phone: this.form.phone, scrapTypeId: this.form.scrapTypeId, status: this.form.status, recyclerPointId: this.form.pointId })
